...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen pb-12 pt-20 lg:pt-32 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
             ...
             {/* Header Text Section */}
        <div
          className="relative text-center pt-24 lg:pt-32 pb-20 bg-cover bg-center bg-no-repeat"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <button className="group inline-flex items-center gap-3 px-8 py-4 border-2 hover:border-[#8BC34A] hover:bg-transparent hover:text-white font-semibold rounded-full bg-[#8BC34A] text-white border-transparent transition-all duration-300 animate-fadeInUp">
              Explore Projects
      ...
      <div className="container mx-auto px-4 lg:px-0 relative z-20">
        ...
        {/* Images Section */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-12  mt-6 lg:mt-12 relative z-30">
          {/* Left Image */}
          <div className="relative group animate-fadeInLeft">
            <div className="w-64 h-80  rounded-bl-full rounded-tr-full rounded-tl-full   overflow-hidden shadow-2xl transform  transition-transform duration-500">
              <img
          ...
          <div className="relative group animate-fadeInUp">
            <div className="w-[600px] h-96 rounded overflow-hidden shadow-2xl transform  transition-transform duration-500">
              <img
          ...
          <div className="relative group animate-fadeInRight">
            <div className="w-64 h-80  rounded-br-full rounded-tr-full rounded-bl-full overflow-hidden shadow-2xl transform  transition-transform duration-500">
              <img
